    ...
    <>
      ...
      <section className="bg-[#FDF9EE] py-[60px] md:py-[80px]">
        <div className="max-w-[768px] mx-auto px-5 sm:px-10 text-center">
          <p
            className="text-[#0063EB] font-medium text-[14px] leading-[24px] uppercase mb-3"
            style={{ letterSpacing: "0.0893em" }}
          >
            Legal
          </p>
          <h1 className="text-[40px] md:text-[56px] font-semibold text-black leading-tight mb-3">
            Privacy Policy
          </h1>
