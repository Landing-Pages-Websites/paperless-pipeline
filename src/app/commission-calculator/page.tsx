    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(110deg,#FDF9EE_0%,#FDF9EE_32%,#D4E4F7_58%,#DDD8F0_76%,#EDD8E8_100%)] py-20 md:py-28">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-5 px-4 text-center sm:px-6 lg:px-8">
          ...
          <h1
            className="max-w-2xl text-5xl font-semibold text-black tracking-[-0.0375em] md:text-[64px] md:leading-[72px]"
          >
        ...
        <div className="mx-auto max-w-[720px] px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-5">
              <h2 className="text-[32px] font-bold leading-tight text-black md:text-[40px]">
                What is a free real estate commission calculator?
              </h2>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="overflow-hidden rounded-xl">
                <Image
                  src="/images/figma/pages/a962c985abee5035.png"
                  alt="70% Brokerage / 30% Agent commission split illustration"
                  width={1080}
                  height={565}
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base leading-relaxed text-[#4F4F4F]">Using the Standard Commission Calculator</p>
              <p className="text-base font-bold leading-relaxed text-[#4F4F4F]">
                Here is how to use the split commission calculator.
              </p>
              <ol className="list-decimal flex flex-col gap-2 pl-5 text-base text-[#4F4F4F]">
                <li className="leading-relaxed pl-1">Enter the property selling price and the total amount your brokerage receives in commission. The latter is known as gross commission.</li>
                <li className="leading-relaxed pl-1">Enter the percentage of the commission the real estate agent receives from the sale.</li>
                <li className="leading-relaxed pl-1">Add any fees you charge to the agent.</li>
                <li className="leading-relaxed pl-1">Hit the &ldquo;calculate&rdquo; button.</li>
              </ol>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base leading-relaxed text-[#4F4F4F]">These are:</p>
              <ol className="list-decimal flex flex-col gap-3 pl-5 text-base text-[#4F4F4F]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="overflow-hidden rounded-xl">
                <Image
                  src="/images/figma/pages/84f1bd05f631322a.png"
                  alt="Example of a tiered commission split bar chart"
                  width={1080}
                  height={565}
                  className="w-full h-auto"
                />
            ...
            <div className="flex flex-col gap-5">
              ...
              <ol className="list-decimal flex flex-col gap-2 pl-5 text-base text-[#4F4F4F]">
                <li className="leading-relaxed pl-1">Enter the sale price and the commission percentage you receive.</li>
                <li className="leading-relaxed pl-1">Enter the percentage of the commission the agent receives in the current tier and the next tier.</li>
                <li className="leading-relaxed pl-1">Enter the total amount the agent needs to earn to reach the next tier.</li>
                <li className="leading-relaxed pl-1">Enter the amount the agent has already earned in commissions before the current sale.</li>
                <li className="leading-relaxed pl-1">Add any fees the agent needs to pay.</li>
                <li className="leading-relaxed pl-1">Hit &ldquo;calculate.&rdquo;</li>
              </ol>
              <p className="text-base leading-relaxed text-[#4F4F4F]">You&apos;ll then see two different results boxes.</p>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <ul className="list-disc flex flex-col gap-2 pl-5 text-base text-[#4F4F4F]">
                <li className="leading-relaxed pl-1">The percentage of total commission the real estate agent receives on each tier.</li>
                <li className="leading-relaxed pl-1">The total amount they need to earn to reach the next tier.</li>
                <li className="leading-relaxed pl-1">The total amount they have already received from prior sales.</li>
              </ul>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
                You can use{" "}
                <Link href="/features" className="text-[#0063EB] underline hover:no-underline">
                  transaction management software
                </Link>{" "}
                alongside the real estate commission calculator to track the number and value of sales each agent makes.
              </p>
            </div>
            ...
            {/* Referral Fees */}
            <div className="flex flex-col gap-5">
              <h3 className="text-[22px] font-bold leading-tight text-black md:text-[26px]">
                Referral Fees
              </h3>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
              ...
              <div className="overflow-hidden rounded-xl">
                <Image
                  src="/images/figma/pages/629ee4ab869f13bc.png"
                  alt="Referral fee example — Brokerage A $11,200, Agent $4,800, $20,000 Gross Commission, Brokerage B $4,000"
                  width={1080}
                  height={565}
                  className="w-full h-auto"
                />
              </div>
              <h4 className="text-base font-bold text-black">Here&apos;s an Example</h4>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="overflow-hidden rounded-xl">
                <Image
                  src="/images/figma/pages/def4676240168240.png"
                  alt="Franchise fee example — Franchise $360, Agent $2,592, $9,000 Gross Commission, Brokerage $6,048"
                  width={1080}
                  height={565}
                  className="w-full h-auto"
                />
            ...
            <div className="flex flex-col gap-5">
              ...
              <ol className="list-decimal flex flex-col gap-2 pl-5 text-base text-[#4F4F4F]">
                <li className="leading-relaxed pl-1">Set the agent commission rate at 100%</li>
                <li className="leading-relaxed pl-1">Enter the total amount of sales the agent put through in that period</li>
                <li className="leading-relaxed pl-1">Add the flat fee to the &ldquo;Agent Fees Owed&rdquo; field</li>
              </ol>
              <p className="text-base leading-relaxed text-[#4F4F4F]">
